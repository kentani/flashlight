...
.game-result-overlay__content { animation: result-arrive .3s ease-out; max-width: 400px; width: 100%; }
...
.game-result-overlay__detail { font-size: clamp(1.05rem, 4.5vw, 1.4rem); font-weight: bold; }
