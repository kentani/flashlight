...
<style scoped>
.traffic-playground { align-items: center; background: linear-gradient(#83d5f1 0 62%, #85bf65 62% 72%, #50565d 72%); box-sizing: border-box; display: flex; flex: 1 0 100%; justify-content: center; min-height: 100vh; overflow: hidden; padding: 82px 16px 130px; position: relative; width: 100%; }
...
@media (max-width: 390px) { .traffic-playground { padding-left: 10px; padding-right: 10px; }.traffic-board { border-radius: 24px; padding-left: 14px; padding-right: 14px; }.signal-area { height: 207px; }.traffic-light { gap: 8px; padding: 12px; }.lamp { height: 64px; width: 64px; }.pole { height: 76px; width: 19px; }.pole::after { margin-top: 69px; }.signal-button { border-radius: 14px; min-height: 82px; } }
